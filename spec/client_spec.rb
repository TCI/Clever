  ...
  describe 'district data requests' do
    ...
    describe 'students' do
      ...
      context 'with username replacement' do
        let(:student_username_search_for) { '@school.edu' }
    ...
    describe 'teachers' do
      ...
      context 'with username source' do
        ...
        context 'with username replacement' do
          let(:staffer_username_search_for) { '@domain.com' }
          ...
          context 'when username contains search string' do
            it 'replaces the search string with replacement string' do
              ...
              response.each do |teacher|
                if teacher.username&.include?('@domain.com')
                  expect(teacher.username).to include('@newdomain.com')
                  expect(teacher.username).not_to include('@domain.com')
                end
              end
            end
          end
